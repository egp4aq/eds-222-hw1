...
1.  What is the *population* in this setting? Please be precise.
    ...
    The population in this Lahore would be the entire city's pollution levels, regardless of location.

2.  What are the *samples* in this setting? Please be precise.

    The samples in this setting are the specific monitors placed by either the people who volunteered to have one placed in their home or placed in specific locations decided by the government.
...
The sample mean of the crowd-sourced data is closer to the NASA estimate, as it is 70.20 $\mu g/m^3$, while the government data is 39.65 $\mu g/m^3$. I recommend that the Prime Minister relies more heavily on the crowd-sourced data than the government data.
